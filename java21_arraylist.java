...
public class java21_arraylist {
    public static void main(String[] args) {
        // Listeler
        ArrayList<Integer> liste = new ArrayList<>(); //Integer sýnýf tipi olmalý
        liste.add(3);
        liste.add(0);
        liste.add(3);
        liste.add(5);
        ...
        liste.add(0, 1);// 0. indise ekler kalanlarý kaydýrýr
        System.out.println(liste);
        ...
        liste.clear(); //tüm elemanlarý siler
        System.out.println(liste);
